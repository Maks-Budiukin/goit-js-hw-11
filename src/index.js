    ...
    fetchPics()
        .then(result => {
            ...
            if (hits.length === 0) {
                ...
                hideLoadBtn();
                return;
            } else if (hits.length < PIC_PER_PAGE) {
                hideLoadBtn();
        ...
        <div class="info">
          ...
          <p class="info-item">
            ...
            <svg class="gallery__icon" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" id="Icons" style="enable-background:new 0 0 32 32;" version="1.1" width="32" height="32" viewBox="0 0 32 32" xml:space="preserve"><style type="text/css">
	.st0{fill:none;stroke-width:2;stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:10;}
</style><polyline class="st0" points="20,17 16,21 12,17 "/><line class="st0" x1="16" x2="16" y1="21" y2="10"/><title>Downloads</title> <path class="st0" d="M21,29H11c-4.4,0-8-3.6-8-8V11c0-4.4,3.6-8,8-8h10c4.4,0,8,3.6,8,8v10C29,25.4,25.4,29,21,29z"/></svg>
...
//             for (let { webformatURL, largeImageURL, tags, likes, views, comments, downloads } of hits) {
